...
BUILD_DIR="${BUILD_DIR:-/work/spikes/wasix-postgres-build/work/docker-pglite}"
PGSRC="${PGSRC:-/work/spikes/upstream/postgres-pglite}"
...
case "${1:-}" in
  ...
  --localedir)
    ...
    ;;
  --version)
    echo "PostgreSQL 17.4-wasix-pglite-spike"
    ;;
  --configure)
